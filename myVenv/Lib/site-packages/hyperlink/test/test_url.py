...
class TestURL(HyperlinkTestCase):
    ...
    def assertUnicoded(self, u):
        ...
        """
        self.assertTrue(isinstance(u.scheme, unicode) or u.scheme is None, repr(u))
    ...
    def test_click(self):
        ...
        self.assertEqual("http://www.foo.com/click", urlpath.click("/click").to_text())
        ...
        # and path
        self.assertTrue(
            "//foobar" not in urlpath.click("http://www.foo.com/foobar").to_text()
        )
    ...
    def test_normalize(self):
        ...
        assert (
            URL(path=("", "%te%sts")).normalize(percents=False).to_text() == "/%te%sts"
        )
    ...
    def test_idna_corners(self):
        ...
        assert URL.from_text(text).to_uri().get_decoded_url().host == "example.com"
