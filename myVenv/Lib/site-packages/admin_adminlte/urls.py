...
urlpatterns = [
    ...
    path(
        "examples/project-add/", views.examples_project_add, name="examples_project_add"
    ),
    path(
        "examples/project-edit/",
        views.examples_project_edit,
        name="examples_project_edit",
    ),
    path(
        "examples/project-detail/",
        views.examples_project_detail,
    ...
    path(
        "forgot-password-v1/",
        views.UserPasswordResetViewV1.as_view(),
        name="forgot_password_v1",
    ),
    path(
        "forgot-password-v2/",
        views.UserPasswordResetViewV2.as_view(),
        name="forgot_password_v2",
    ),
    path(
        "recover-password-v1/",
        views.UserPasswordChangeViewV1.as_view(),
        name="recover_password_v1",
    ),
    path(
        "recover-password-v2/",
        views.UserPasswordChangeViewV2.as_view(),
        name="recover_password_v2",
    ),
    ...
    path(
        "fixed-sidebar-custom/", views.fixed_sidebar_custom, name="fixed_sidebar_custom"
    ),
