...
class TestFbsValidatePermissionAllow(TestFbsBase):
    ...
    def test_validate_PermissionAllow_invalid(self):
        tests = [
            ...
            (
                {"call": True, "register": True, "publish": True, "subscribe": 666},
                "invalid type",
            ),
            (
                {"call": True, "register": True, "publish": True, "subscribe": None},
                "invalid type",
            ),
            (
                {
...
class TestFbsValidateRolePermission(TestFbsBase):
    ...
    def test_validate_RolePermission_invalid(self):
        tests = [
            ...
            (
                {"uri": "com.example.", "allow": {"some_unexpected_key": True}},
                "unexpected argument",
            ),
            ({"uri": 666}, "invalid type"),
            (
                {"uri": "com.example.", "match": "prefix", "allow": {"call": 666}},
                "invalid type",
            ),
            (
                {
...
class TestFbsValidateRealmConfig(TestFbsBase):
    ...
    def test_start_router_realm_invalid(self):
        tests = [
            ...
            (
                ["realm023", {"name": "realm1", "roles": [{"name": 666}]}],
                None,
                "invalid type",
            ),
        ]
