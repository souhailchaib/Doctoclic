...
from constantly import NamedConstant, Names, ValueConstant, Values, FlagConstant, Flags
...
class OrderedConstantsTests(TestCase):
    ...
    def test_orderedDifferentConstants_lt(self):
        ...
        """
        self.assertEquals(
            NotImplemented, NamedLetters.alpha.__lt__(ValuedLetters.alpha)
        )
    ...
    def test_orderedDifferentConstants_le(self):
        ...
        """
        self.assertEquals(
            NotImplemented, NamedLetters.alpha.__le__(ValuedLetters.alpha)
        )
    ...
    def test_orderedDifferentConstants_gt(self):
        ...
        """
        self.assertEquals(
            NotImplemented, NamedLetters.alpha.__gt__(ValuedLetters.alpha)
        )
    ...
    def test_orderedDifferentConstants_ge(self):
        ...
        """
        self.assertEquals(
            NotImplemented, NamedLetters.alpha.__ge__(ValuedLetters.alpha)
        )
