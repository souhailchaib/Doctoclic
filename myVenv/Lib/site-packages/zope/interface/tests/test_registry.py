...
class ComponentsTests(unittest.TestCase):
    ...
    def test_registerUtility_both_factory_and_component(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.registerUtility, component=_to_reg, factory=_factory
        )
    ...
    def test_registerUtility_w_component(self):
        ...
        self.assertEqual(
            comp._utility_registrations[ifoo, _name], (_to_reg, _info, None)
        )
    ...
    def test_registerUtility_w_different_info(self):
        ...
        self.assertEqual(
            comp._utility_registrations[(ifoo, _name)], (_to_reg, _info2, None)
        )  # replaced
        self.assertEqual(comp.utilities._subscribers[0][ifoo][""], (_to_reg,))
    ...
    def test_registerUtility_w_different_names_same_component(self):
        ...
        self.assertEqual(
            comp._utility_registrations[(ifoo, _name1)], (_other_reg, _info, None)
        )
        self.assertEqual(
            comp._utility_registrations[(ifoo, _name2)], (_to_reg, _info, None)
        )
        self.assertEqual(
            comp.utilities._subscribers[0][ifoo][""],
            (
                _other_reg,
                _to_reg,
            ),
    ...
    def test_unregisterUtility_both_factory_and_component(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.unregisterUtility, component=_to_reg, factory=_factory
        )
    ...
    def test_unregisterUtility_w_existing_subscr_other_component(self):
        ...
        with _monkey:
            comp.unregisterUtility(_to_reg, ifoo, _name2)
        self.assertEqual(comp.utilities._subscribers[0][ifoo][""], (_other_reg,))
    ...
    def test_getUtilitiesFor_hit(self):
        ...
        self.assertEqual(
            sorted(comp.getUtilitiesFor(ifoo)), [(_name1, _to_reg), (_name2, _to_reg)]
        )
    ...
    def test_registerAdapter_with_component_name(self):
        ...
        self.assertEqual(
            comp._adapter_registrations[(ibar,), ifoo, "foo"], (Foo, _info)
        )
    ...
    def test_registerAdapter_w_explicit_provided_and_required(self):
        ...
        self.assertEqual(
            comp._adapter_registrations[(ibar,), ifoo, _name], (_factory, _info)
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerAdapter_no_provided_available(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.registerAdapter, _Factory, (ibar,), name=_name, info=_info
        )
    ...
    def test_registerAdapter_w_required_containing_None(self):
        ...
        with _monkey:
            comp.registerAdapter(
                _Factory, [None], provided=ifoo, name=_name, info=_info
            )
        self.assertTrue(comp.adapters._adapters[1][Interface][ifoo][_name] is _Factory)
        self.assertEqual(
            comp._adapter_registrations[(Interface,), ifoo, _name], (_Factory, _info)
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerAdapter_w_required_containing_class(self):
        ...
        with _monkey:
            comp.registerAdapter(
                _Factory, [_Context], provided=ifoo, name=_name, info=_info
            )
        self.assertTrue(comp.adapters._adapters[1][_ctx_impl][ifoo][_name] is _Factory)
        self.assertEqual(
            comp._adapter_registrations[(_ctx_impl,), ifoo, _name], (_Factory, _info)
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerAdapter_wo_explicit_required(self):
        ...
        _monkey, _events = self._wrapEvents()
        with _monkey:
            comp.registerAdapter(_Factory, provided=ifoo, name=_name, info=_info)
        self.assertTrue(comp.adapters._adapters[1][ibar][ifoo][_name] is _Factory)
        self.assertEqual(
            comp._adapter_registrations[(ibar,), ifoo, _name], (_Factory, _info)
        )
    ...
    def test_unregisterAdapter_neither_factory_nor_provided(self):
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.unregisterAdapter, factory=None, provided=None
        )
    ...
    def test_getAdapter_miss(self):
        ...
        _context = _Context()
        comp = self._makeOne()
        self.assertRaises(ComponentLookupError, comp.getAdapter, _context, ifoo)
    ...
    def test_queryMultiAdapter_miss_w_default(self):
        ...
        comp = self._makeOne()
        self.assertTrue(
            comp.queryMultiAdapter((_context1, _context2), ifoo, default=_default)
            is _default
        )
    ...
    def test_getMultiAdapter_miss(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            ComponentLookupError, comp.getMultiAdapter, (_context1, _context2), ifoo
        )
    ...
    def test_registerSubscriptionAdapter_w_explicit_provided_and_required(self):
        ...
        self.assertEqual(
            comp._subscription_registrations, [((ibar,), ifoo, _blank, _factory, _info)]
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerSubscriptionAdapter_wo_event(self):
        ...
        with _monkey:
            comp.registerSubscriptionAdapter(
                _factory, (ibar,), ifoo, info=_info, event=False
            )
        self.assertEqual(len(_events), 0)
    ...
    def test_unregisterSubscriptionAdapter_neither_factory_nor_provided(self):
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.unregisterSubscriptionAdapter, factory=None, provided=None
        )
    ...
    def test_registerHandler_w_nonblank_name(self):
        ...
        self.assertRaises(
            TypeError, comp.registerHandler, _factory, required=ifoo, name=_nonblank
        )
    ...
    def test_registerHandler_w_explicit_required(self):
        ...
        self.assertTrue(reg[0] is _factory)
        self.assertEqual(
            comp._handler_registrations, [((ifoo,), _blank, _factory, _info)]
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_unregisterHandler_w_nonblank_name(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.unregisterHandler, required=(ifoo,), name=_nonblank
        )
    ...
    def test_rebuildUtilityRegistryFromLocalCache(self):
        ...
        self.assertEqual(
            len(new_subscribers[0][IFoo][""]), len(orig_subscribers[0][IFoo][""])
        )
...
class AdapterRegistrationTests(unittest.TestCase):
    ...
    def test___repr__(self):
        ...
        self.assertEqual(
            repr(ar),
            ("AdapterRegistration(_REGISTRY, [IBar], IFoo, %r, TEST, " + "'DOCSTRING')")
            % (_name),
        )
    ...
    def test___repr___provided_wo_name(self):
        ...
        self.assertEqual(
            repr(ar),
            ("AdapterRegistration(_REGISTRY, [IBar], None, %r, TEST, " + "'DOCSTRING')")
            % (_name),
        )
...
class HandlerRegistrationTests(unittest.TestCase):
    ...
    def test___repr___factory_w_name(self):
        ...
        self.assertEqual(
            repr(hr),
            ("HandlerRegistration(_REGISTRY, [IFoo], %r, TEST, " + "'DOCSTRING')")
            % (_name),
        )
