...
class Components:
    ...
    def registerUtility(
        self, component=None, provided=None, name="", info="", event=True, factory=None
    ):
        if factory:
            if component:
    ...
    def unregisterUtility(self, component=None, provided=None, name="", factory=None):
        if factory:
            if component:
                raise TypeError("Can't specify factory and component.")
            component = factory()
    ...
    def registerHandler(self, factory, required=None, name="", info="", event=True):
        if name:
