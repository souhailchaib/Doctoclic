...
class ClientModel(models.Model):
    ...
    client_provenance = models.CharField(max_length=100, blank=True, null=True, default=None, choices=CLIENT_PROVENANCE)


    client_id_externe = models.CharField(max_length=500, blank=True, null=True)
    client_ref_mutuelle_externe = models.CharField(max_length=500, blank=True, null=True)
